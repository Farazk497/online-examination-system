...
if(@$_GET['fdid'] && $_SESSION['key']=='Scholars Education') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='Scholars Education') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='Scholars Education') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='Scholars Education') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='Scholars Education') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
$c=$_POST[$i.'3'];
$d=$_POST[$i.'4'];
// Replace these four queries
$qa = $con->prepare("INSERT INTO options VALUES (?, ?, ?)");
$qa->bind_param("sss", $qid, $a, $oaid);
$qa->execute() or die('Error61');

$qb = $con->prepare("INSERT INTO options VALUES (?, ?, ?)");
$qb->bind_param("sss", $qid, $b, $obid);
$qb->execute() or die('Error62');

$qc = $con->prepare("INSERT INTO options VALUES (?, ?, ?)");
$qc->bind_param("sss", $qid, $c, $ocid);
$qc->execute() or die('Error63');

$qd = $con->prepare("INSERT INTO options VALUES (?, ?, ?)");
$qd->bind_param("sss", $qid, $d, $odid);
$qd->execute() or die('Error64');
$e=$_POST['ans'.$i];
switch($e)
{
case 'a':
...
else if( $_SESSION['key']!='Scholars Education')
{
